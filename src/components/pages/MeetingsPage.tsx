...
import { ArrowLeft, Video, Search, Filter, Plus, Calendar, Users, Clock, MapPin } from 'lucide-react';
...
const MeetingsPage: React.FC<MeetingsPageProps> = ({ 
  ...
  const handleAddMeeting = () => {
    // Implement add meeting functionality
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <h1 className="text-xl font-bold text-slate-800">
              {language === 'tr' ? 'Toplantılar' : 'Meetings'}
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className={`transition-all duration-1000 ${isLoaded ? 'animate-fade-in-up' : 'opacity-0'}`}>
          {/* Toolbar */}
          <SearchToolbar
            placeholder={language === 'tr' ? 'Toplantılarda ara...' : 'Search meetings...'}
            onSearch={handleSearch}
            onFilter={toggleFilters}
            onAdd={handleAddMeeting}
            addButtonText={language === 'tr' ? 'Toplantı Oluştur' : 'Create Meeting'}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 glass-input rounded-lg text-sm">
                    ...
                    <option value="my">Katıldığım Toplantılar</option>
                    <option value="organized">Düzenlediğim Toplantılar</option>
                  </select>
                </div>
          ...
          <div className="text-center py-16">
            ...
            <p className="text-slate-600">
              {language === 'tr' ? 'Toplantı planlama ve yönetim merkezi.' : 'Meeting planning and management center.'}
            </p>
            {searchQuery && (
