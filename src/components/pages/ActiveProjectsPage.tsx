...
import { ArrowLeft, Target, Search, Filter, Plus, Play, Users, Calendar, TrendingUp, AlertTriangle, Clock, CheckCircle } from 'lucide-react';
import { Language } from '../../types';
import SearchToolbar from '../SearchToolbar';

interface ActiveProjectsPageProps {
  language: Language;
  userInfo: {
    firstName: string;
    lastName: string;
...
const ActiveProjectsPage: React.FC<ActiveProjectsPageProps> = ({ 
  language, 
  userInfo, 
  onBack, 
  onLogout 
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <h1 className="text-xl font-bold text-slate-800">
              {language === 'tr' ? 'Aktif Projeler' : 'Active Projects'}
            </h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className={`transition-all duration-1000 ${isLoaded ? 'animate-fade-in-up' : 'opacity-0'}`}>
          {/* Toolbar */}
          <SearchToolbar
            placeholder={language === 'tr' ? 'Aktif projelerde ara...' : 'Search active projects...'}
            onSearch={handleSearch}
            onFilter={toggleFilters}
            onAdd={handleAddProject}
            addButtonText={language === 'tr' ? 'Yeni Proje' : 'Add Project'}
            ...
            <div className="glass-card rounded-2xl p-6 mb-8 animate-fade-in-up">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <select className="w-full px-3 py-2 glass-input rounded-lg text-sm">
                    <option value="all">Tüm İlerlemeler</option>
          ...
          <div className="text-center py-16">
            ...
            <p className="text-slate-600">
              {language === 'tr' ? 'Devam eden projelerinizi burada görüntüleyebilirsiniz.' : 'View your ongoing projects here.'}
            </p>
            {searchQuery && (
