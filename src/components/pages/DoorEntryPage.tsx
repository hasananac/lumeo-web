...
const DoorEntryPage: React.FC = () => {
  ...
  const translations = {
    tr: {
      title: "Kapı Giriş Kayıtları",
      subtitle: "Tüm giriş kayıtlarını görüntüleyin ve yönetin",
      search: "Giriş kayıtlarında ara...",
      filters: {
        all: "Tümü",
        today: "Bugün",
        thisWeek: "Bu Hafta",
      ...
      stats: {
        ...
        todayEntries: "Bugünkü Giriş",
        successRate: "Başarı Oranı",
        activeCards: "Aktif Kartlar",
      },
    },
    en: {
      title: "Door Entry Records",
      subtitle: "View and manage all entry records",
      search: "Search entry records...",
      filters: {
        all: "All",
        today: "Today",
        thisWeek: "This Week",
  ...
  const entryRecords = [
    ...
    },
    {
      ...
      person: "Ayşe Şahin",
      cardId: "C002123",
      location: "Personel Girişi - Kapı 3",
      status: "successful",
    },
    {
      id: 5,
  ...
  const stats = [
    {
      title: currentT.stats.totalEntries,
      value: "1,234",
      change: "+12%",
      positive: true,
    },
    {
      title: currentT.stats.todayEntries,
      value: "45",
      change: "+8%",
      positive: true,
    },
